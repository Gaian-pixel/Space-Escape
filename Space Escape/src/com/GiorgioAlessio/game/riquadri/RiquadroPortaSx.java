...
public class RiquadroPortaSx extends Riquadro
{
	private Animazione animazioneTile;
	private boolean aperta;
	private boolean aperturaPorta;
	
	public RiquadroPortaSx(int id)
	{
		super(Risorse.porta[3], id);
		animazioneTile = new Animazione(150,Risorse.portaSinistra);
	...
	public void aggiornamento()
	{
		...
		if(aperturaPorta)
		{
			...
			if(texture.equals(Risorse.portaSinistra[3]))
			{
				aperturaPorta = false;
				aperta = true;
			}
		...
		{
			texture = Risorse.portaSinistra[3];
		}
		else
		{
			texture = Risorse.porta[3];
		}
	}
